...
<body>
  ...
  <h2>👥 Team Members</h2>
  <ul>
  <li><strong>Jeevan S</strong> – Frontend Developer</li>
  ...
  <ul>
    <li><strong>application.properties</strong> → <code>D:\Study-Group-Finder\backend\src\main\resources\application.properties</code></li>
    <li><strong>application-local.properties</strong> → <code>..\Study-Group-Finder\backend\src\main\resources\application-local.properties</code></li>
  </ul>
